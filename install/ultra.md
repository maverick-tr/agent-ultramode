---
description: Best-of-N with a reasoned verifier and guided repair. Runs N isolated attempts in parallel, picks the strongest, then improves it.
argument-hint: <describe your task or challenge...>
allowed-tools: [spawn_subagent, get_command_or_subagent_output, Task, TodoWrite, Read, Write, Edit, Bash, Glob, Grep]
---
